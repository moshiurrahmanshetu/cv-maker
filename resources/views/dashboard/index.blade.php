...
<div class="d-flex flex-column flex-md-row align-items-md-center justify-content-between gap-3 mb-4">
    <div>
        ...
        <p class="text-muted small mb-0">Manage your CVs, resume drafts, and profile sections.</p>
    </div>
...
<!-- Quick Stats Row (Real user metrics, no fake data) -->
<div class="row g-3 mb-4">
    <div class="col-sm-6 col-lg-4">
        <div class="stat-widget">
            <div>
                <div class="stat-widget-label">Total CVs</div>
...
<div class="card card-saas">
    <div class="card-header bg-white border-bottom py-3 px-4 d-flex align-items-center justify-content-between">
        <div class="fw-bold">
            <i class="bi bi-clock-history me-1"></i> Recent CVs
        </div>
    ...
    <div class="card-body p-4">
        @if($recentCvs->isEmpty())
            <div class="text-center py-5">
                ...
                <h3 class="h5 fw-bold mb-1">No CVs created yet</h3>
                <p class="text-muted small mb-4">Start by creating your first resume draft. You can save as a draft anytime.</p>
                <a href="{{ route('cvs.create') }}" class="btn-saas-primary">
                    <i class="bi bi-plus-lg"></i> Create First CV
                </a>
            </div>
        @else
            <div class="row g-3">
